...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="lblTicketNo" runat="server" style="z-index: 1; left: 244px; top: 181px; position: absolute" Text="Label"></asp:Label>
            <asp:Label ID="lblProblemNo" runat="server" style="z-index: 1; left: 244px; top: 244px; position: absolute" Text="Label"></asp:Label>
